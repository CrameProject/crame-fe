const Header = () => {
  return (
    <header className="w-full min-w-[768px] bg-amber-200 py-3">
      <div className="mx-auto flex max-w-screen-xl items-center justify-between px-12">
        ...
        <div className="flex items-center gap-4">
          <button className="rounded border border-blue-500 px-6 py-2 text-blue-500 transition hover:bg-blue-50">
            로그인
          </button>
